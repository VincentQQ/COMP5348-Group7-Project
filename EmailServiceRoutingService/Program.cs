...
namespace EmailServiceRoutingService
{
    public class Router
    {
        ...
        public static void Main()
        {
                ...
                new ServiceHost(typeof(RoutingService)))
            {
                ...
                Console.WriteLine("The Email Routing Service configured, opening....");
                serviceHost.Open();
                Console.WriteLine("The Email Routing Service is now running.");
